...
Class Email extends CI_Controller{
	...
	function enviar(){
		...
		switch ($this->input->post('tipo')) {
			...
			case "compra":
				$texto = "<h3>Estimado <b>".$datos['nombre'].":</b></h3><br>Le damos la bienvenida a nuestra campaña <b><i>No al Maltrato infantil</i></b>.<br>Disfrute de este regalo enviado por la empresa privada, es 100% creado en la fundación, como todos los cuentos para adultos y para niños.<br>Queremos que lo haga en reconocimiento a un niño maltratado.<br>De 40 a 50 minutos, en este tiempo usted lo leerá con calma, y si le quedó gustando, regale este cheque a un amigo, es otra forma de ayudar.<br>Le estamos enviando adjuntos los archivos del libro que ha adquirido.<br>De 40 a 50 minutos, en este tiempo usted lo leerá con calma, y si le quedo gustando, regale este cheque a un amigo, es otra forma de ayudar.<br>Estos archivos son los siguientes: <ol><li>Información para ahcer las donaciones</li><li>La portada de todos los libros de nuestra biblioteca</li><li>La portada del libro de poesía</li><li>El libro <b>¿Qué clase de animal eres tú?</b></li></ol>";
